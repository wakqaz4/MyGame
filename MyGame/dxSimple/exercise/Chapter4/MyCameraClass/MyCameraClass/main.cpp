...
* project(MyCameraClass2_Wrapped)
...
bool ObjectInit()
{
	PlaySound(_T("¥³¥ί¥Ν¥κ¥µ - Resuscitated Hope.wav"), nullptr, SND_ASYNC | SND_FILENAME | SND_LOOP);
	D3DXCreateFont(gPD3DDevice, 38, 0, 0, 0, 0, 0, 0, 0, 0, _T("Ώ¬Με"), &gPFont);
...
void Direct3DRender(HWND hwnd)
{
	...
	gPD3DDevice->Clear(0, nullptr, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, D3DCOLOR_XRGB(24, 12, 33), 1.0f, 0);
