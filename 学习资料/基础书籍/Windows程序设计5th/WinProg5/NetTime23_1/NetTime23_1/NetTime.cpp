...

{
	...
	hwndModeless = CreateDialog(hInstance, MAKEINTRESOURCE(NETTIME), hwnd, MainDlg);
...

{
	...
	case   WM_COMMAND:
		...
		case   IDC_SERVER:
			...
			DialogBoxParam(hInst,MAKEINTRESOURCE(SERVER), hwnd, ServerDlg, (LPARAM)szIPAddr);
